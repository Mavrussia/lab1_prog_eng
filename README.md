...
### Вывод:
Эта задача помогает понять, как работает взаимодействие объектов в программировании. Мы создали три класса — Tomato, TomatoBush и Gardener. Каждый класс выполняет свою задачу:
